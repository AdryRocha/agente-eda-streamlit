...
if prompt := st.chat_input("Faça uma pergunta sobre seus dados..."):
    ...
    if st.session_state.agent_executor is None:
        st.warning(
            "⚠️ Por favor, carregue um arquivo CSV "
            "e clique em 'Iniciar Análise'."
        )
        ...
        with st.chat_message("assistant"):
            with st.spinner("Pensando..."):
                try:
                    ...
                    error_message = (
                        "⏳ O limite temporário do plano gratuito "
                        "do Gemini foi atingido. Aguarde cerca de "
                        "30 segundos e tente novamente."
                    )
                    ...
                    # O erro completo aparece apenas nos logs.
                    traceback.print_exc()
